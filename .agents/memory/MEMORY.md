...
- [Desktop can't resolve @workspace/* imports](desktop-workspace-package-imports.md) — shared pages importing `@workspace/*` break the out-of-workspace desktop bundle; alias to a `desktop/stubs/` stub in vite + tsconfig, don't fork the page.
